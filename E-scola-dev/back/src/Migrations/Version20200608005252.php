 ...
 */
final class Version20200608005252 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE assigments ADD mark INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE assigments DROP mark');
        $this->addSql('ALTER TABLE lessons CHANGE activity_id activity_id INT DEFAULT NULL');
